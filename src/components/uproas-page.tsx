...
export function UproasPage() {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
    ...
    <main id="top">
      ...
      <section id="proof" className="bg-background py-24 sm:py-32"><div className="mx-auto max-w-5xl px-5"><p className="eyebrow">THE TRACK RECORD</p><h2 className="section-title">Over the last 24 months, our team has spent over $15 million dollars on Facebook Ads…</h2><p className="mt-8 font-display text-3xl font-bold text-primary">Here’s the proof:</p><div className="mt-10 grid gap-5 md:grid-cols-2"><img src={media.imgi_94_facebook_ads_more_proof_768x2148_jpg} alt="Facebook Ads campaign performance proof" width={768} height={2148} className="w-full border border-border"/><img src={media.imgi_95_facebook_ads_more_proof_549x1536_jpg} alt="Additional Facebook Ads campaign performance proof" width={549} height={1536} className="w-full border border-border"/></div><div className="my-12 grid gap-px overflow-hidden border border-border bg-border sm:grid-cols-3"><Stat value="$15M" label="All with ads."/><Stat value="1184" label="different industries and niches."/><Stat value="$10.2B" label="in sales."/></div><div className="sales-copy"><p>And we’ve done this in over 1184 different industries and niches.</p><p>Using that $15 million to help generate our clients $10.2 billion in sales.</p><p className="font-bold text-primary">All with ads.</p><p>And look, when you spend that kinda dough on ads – in so many different industries – you learn a lot.</p><p>About exactly what works, and what doesn’t.</p><p>Not theoretically what works.</p><p>From some YouTube tutorials and courses.</p><p>Or from some guru with a bunch of “theories” pretending to be an “expert”.</p><p>No.</p><p>I’m talkin’ about NO-BS, battle-tested strategies from the frontlines of turning advertising into profit.</p><p>From a team who knows what it means to have to make ad campaigns profitable – because they’ve got a payroll to meet.</p></div></div></section>
      ...
      <section className="bg-background py-24 sm:py-32"><div className="mx-auto max-w-4xl px-5"><div className="sales-copy"><p>But, please, don’t take our word for it…Here is the money-multiplying…..</p><p>It’s stories like these that (almost) make our eyes sweat.</p><p>Okay, enough of that….</p><p>Let’s talk about the actual ads.</p><p>More specifically…</p><p>How to take your ads manager… and turn it into a majestical place…</p><p>Bringing you all types of gifts, like:</p><p>This place is not fictional.</p><p>It exists.</p><p>Come closer. Listen, lemme show you how to get there.</p><p>More specifically, how to scale ad spend to the moon and maintain profitability.</p><p>So you can make some extra M-O-N-E-Y.</p><p>So you can buy things. Expensive things…</p><p>Like Dyson fans and Aesop hand cream…. and weird flavoured juice combinations.</p><p>Yep, we’re going to reveal, the fastest, simplest, and most certain way, for you to get as many customers as possible using Facebook Ads.</p><p>Alright, saddle up.</p><p>Here we go…</p></div><img src={media.imgi_144_social_bubble_1_png} alt="Social advertising audience illustration" width={1472} height={661} loading="lazy" className="mt-14 w-full"/></div></section>

      <section className="bg-section py-24 sm:py-32"><div className="mx-auto max-w-4xl px-5"><p className="eyebrow">THE WORDS / COPY</p><div className="sales-copy"><p>It’s the secret sauce.</p><p>And it all comes down to the words you use in your ads.</p><p>That’s right.</p><p>The copy.</p><p>When you get the words right, everything is cheaper.</p><p>Usually, a lot cheaper.</p><p>CPMs are stunningly lower.</p><p>Your cost per click drops.</p><p>Leads are cheaper.</p><p>And, as a result…</p><p>Your cost to get a customer is cheaper.</p><p>MUCH cheaper.</p><p>And you make a whole lot more dinero.</p><p>As for the words.</p><p>Keep it simple and use short sentences.</p><p>One thought per sentence, so you’re easily understood.</p><p>Don’t use words that make people think.</p><p>In terms of how much copy should you write?</p><p>It’s LONG copy for the win.</p><p>When it’s engaging, of course.</p><p>But it can’t just be long, for the sake of being long!</p><p>That ain’t gonna cut the mustard.</p><p>Focus on being different.</p><p>Unusual.</p><p>And as DRAMATIC as possible!</p><p>Because your ads have to compete with videos of dogs wearing shoes…</p><p>And…</p><p>It’s a wild, wild, world out there.</p><p>There’s a war for attention taking place.</p><p>And you gotta be polarising or you’ll be ignored.</p><p>Yeah, you’ll get some trolls, but you can’t make an omelette without breaking some eggs.</p><p>However, what most people don’t realize is this…</p><p>If you get the psychology wrong, you can’t get words right.</p><p>But… If you follow these steps your ads will sell like crazy.</p><p>And before you say…</p><p>“But my business is different and this won’t work for me”.</p><p>Don’t forget we’ve done this in over 1184 different niches…</p><p>And have generated $10.2 billion in sales for our clients.</p><p>And this is working with excellent success for any product or service.</p><p>Selling at any price point.</p><p>And in any niche.</p><p>Which brings me to the last step.</p><p>These are just a handful of the smart tactics we use to radically and rapidly grow sales for our clients.</p><p>But look, these are just a handful of strategies we use to flood businesses with a torrential downpour of customers using Facebook Ads.</p><p>Wanna see ’em all?</p><p>Then we’ve got some good news for you…</p><p>Because we’ve just put together a brand new free report that reveals…</p></div></div></section>

      <section className="overflow-hidden border-y border-border bg-background py-20"><p className="mb-10 text-center text-xs font-black uppercase tracking-[0.22em] text-muted-foreground">BECOME OUR NEXT SUCCESS STORY</p><div className="marquee"><div className="marquee-track">{[...clients,...clients].map((name,i)=><span key={`${name}-${i}`} className="mx-8 inline-flex items-center gap-8 whitespace-nowrap font-display text-2xl font-black text-primary/70"><span className="size-1.5 rounded-full bg-brand-mark"/>{name}</span>)}</div></div><div className="mx-auto mt-16 grid max-w-7xl grid-cols-2 gap-3 px-5 sm:grid-cols-3 lg:grid-cols-6">{campaignTiles.map(([src,name],i)=><figure key={`${name}-${i}`} className="group relative overflow-hidden bg-section"><img src={src} alt={`${name} campaign work`} width={782} height={1036} loading="lazy" className="aspect-[3/4] h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"/><figcaption className="absolute inset-x-0 bottom-0 bg-primary/90 px-3 py-3 text-center text-[10px] font-black leading-tight text-primary-foreground">{name}</figcaption></figure>)}</div><div className="mx-auto mt-8 max-w-5xl px-5"><img src={media.porfolio_png} alt="UPROAS Facebook advertising portfolio" width={732} height={2048} loading="lazy" className="w-full border border-border"/></div></section>

      <section className="bg-section py-24 sm:py-32"><div className="mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-[1fr_0.8fr] lg:items-center"><div><p className="eyebrow">FREE FACEBOOK TARGETING REPORT</p><h2 className="section-title">DOWNLOAD YOUR FREE REPORT NOW BEFORE THIS PAGE COMES DOWN</h2><p className="mt-7 text-xl leading-relaxed text-muted-foreground">This report is 100% FREE and reveals 12 Secret Facebook Targeting Methods That Unlock “Hidden” Audiences & ‘Hyper Active Buyers’ in 30 Days or Less.</p><div className="mt-7 sales-copy text-base"><p>Get for free what has cost us millions of dollars in ad spend to find out.</p><p>Here is just a fraction of what you’ll discover:</p><p>Anyway… this report is yours free, just enter your details in the box below and hit the “send me my report” button…</p><p>And these sales-exploding tips will be sent straight to your inbox as a PDF report.</p></div></div><div><img src={media.imgi_147_ebook_bg_seo_secrets_png_webp} alt="Free Facebook targeting methods report preview" width={1720} height={921} loading="lazy" className="mb-5 w-full"/><form className="border border-border bg-background p-7 shadow-premium sm:p-10" onSubmit={(e)=>{e.preventDefault();setReportOpen(true)}}><label htmlFor="report-email" className="mb-3 block text-sm font-bold text-primary">Where should we send it?</label><Input id="report-email" required type="email" placeholder="Your best email address" className="h-14 bg-background px-4"/><Button size="lg" className="mt-4 h-14 w-full text-base">Send me my report <ArrowRight/></Button><p className="mt-4 text-center text-xs text-muted-foreground">100% FREE</p></form></div></div></section>

      <section className="bg-background py-24 sm:py-32"><div className="mx-auto max-w-5xl px-5"><div className="border-y border-primary py-12 text-center"><ShieldCheck className="mx-auto mb-6 size-12 text-primary"/><p className="eyebrow">30% IMPROVEMENT GUARANTEE</p><h2 className="mx-auto max-w-4xl font-display text-4xl font-extrabold uppercase leading-tight text-primary sm:text-5xl">We’ll design a new funnel, write new ads, and optimise performance until we beat your existing conversion rate, CPL, or ROAS by 30% within 90 days or we work for free until we do.</h2></div><div className="mx-auto mt-16 max-w-3xl"><div className="sales-copy text-center"><p>But, if you’ve seen enough… and just want to know, without a shadow-of-a-doubt…</p><p>This is for businesses already running profitable Google or Facebook ads.</p><p>You cover ad spend. We control the creative. And the campaigns naturally need to be apples-to-apples comparable (same product, same season, etc).</p><p>We have just re-opened our doors to accept new clients and if you are reading this – it means we probably still have a couple of spots available.</p></div><p className="mt-10 font-display text-3xl font-bold text-primary">And, for the month of September, we’re offering businesses in Lagos FREE 30-minute strategy sessions.</p><div className="mt-8 sales-copy text-center"><p>On this call we’ll show you what it will take to truly explode your sales beyond all belief with Facebook Ads.</p><p>But I’ll stop you right there.</p><p>This isn’t just another “strategy session” (*cough* sales pitch), with some dumb-dumb…Who knows nothing about running ads.</p><p>No.</p><p>Nor is it some high-pressure sales pitch masquerading as a strategy session.</p><p>Anyhoo, you can find out more about what’s included in the call here.</p><p>But, spots are almost gone for August September.</p><p>So go here.</p><p>If not now, then when? ?</p></div><Button onClick={claim} size="lg" className="mt-9 h-14 w-full px-8 text-base">Claim Free Session <ArrowRight/></Button></div><div className="mt-20 border-l-4 border-primary bg-section p-7 sm:p-10"><p className="mb-5 font-display text-3xl font-black text-primary">P.S.</p><div className="sales-copy text-base"><p>Here’s the deal… After spending over $15,000,000 on Facebook ads, we’ve turned over every stone, tried every tactic, “hack”, bid strategy, and flipped literally EVERY switch in ad manager there is to flick that will generate a surge in results.</p><p>Seriously.</p><p>If there was so much as a rumour of a Facebook ads strategy, even on the other side of the world, we’ve hunted it down and tested it.</p><p>If there was some hotshot claiming to be a master media buyer in some god-forsaken corner of the earth, we found them.</p><p>If there was so much as a whisper of a secret ad strategy ANYWHERE, we’ve tested it.</p><p>Our team’s experience is DEEP!</p><p>A pack of media buying and copywriting savages… ready to unleash on your business, market and competition. And we play to win.</p><p>So you’re probably wondering why are we doing this?</p><p>Well, we know you’re gonna be so impressed with the plan we put together, that you MIGHT want to become a client to have our team put this plan in place for you.</p><p>And if not, all good, no-hard feelings – you’ll still be left with an incredible plan of attack, that we literally charge $2,250 per hour for.</p><p>On this call, you’ll be getting a fully customized breakdown of our proprietary system for growing businesses at breakneck speed…</p><p>Speak soon.</p><p>This new and unique “tickle the pixel method” is super simple and fast to apply… and truly explodes sales beyond all belief!</p><p>It can be used for any business, in any industry, selling anything!… and is like nothing you’ve ever seen or heard about before!</p><p>If not now, then when? ?</p></div></div></div></section>
